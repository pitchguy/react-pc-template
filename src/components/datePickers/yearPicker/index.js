...
class Index extends Component {
    ...
    render() {
        ...
        const suffix = <Icon onClick={this.iconClick} style={{ color: 'rgba(0, 0, 0, 0.25)' }} type='calendar' />

        return (
            <div className="selection1 selection dataPickerBox" style={{...this.props.style}} ref={(ref) => { this.dataPickerBox = ref }}>
                <Input type="text" onClick={this.handleselect.bind(this)} value={this.state.time.format('YYYY')} readOnly="readonly" suffix={suffix} />
                        ...
                        this.state.showYearPanel ?
                            <div className="ant-calendar-picker-container ant-calendar-picker-container-placement-bottomLeft">
                                <Calendar
                                    ...
                                    getCalendarContainer={(trigger) => { return document.querySelector('.dataPickerBox') }}
